...
FlameShock:SetScript('OnUpdate', function(self,elapsed)
...
FlameShock:SetScript("OnEvent",function(self,event)
	...
	if (event ~= "COMBAT_LOG_EVENT_UNFILTERED" or Auras.db.char.isFirstEverLoad or spec == 2) then
		return
	end
